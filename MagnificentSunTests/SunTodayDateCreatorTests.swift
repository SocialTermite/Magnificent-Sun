...
class SunTodayDateCreatorTests: XCTestCase {
    let testPairs: [Date: String] = [
        Date(year: 2019, month: 4, day: 16, hour: 0, minute: 0): "2019/04/16/",
        Date(year: 2020, month: 10, day: 1, hour: 0, minute: 0): "2020/10/01/",
        Date(year: 2019, month: 12, day: 31, hour: 0, minute: 0): "2019/12/31/",
        Date(year: 2020, month: 1, day: 1, hour: 0, minute: 0): "2020/01/01/",
    ]
