...
class SunTodayURLCreatorTests: XCTestCase {
    ...
    private let testPairs: [SunURLIn: URL] = [
        .init(lenght: .l_304, type: .s_256, date: Date(year: 2020, month: 01, day: 03, hour: 0, minute: 0)):
        URL(string: "http://suntoday.lmsal.com/sdomedia/SunInTime/2020/01/03/t0304.jpg")!,
        
        .init(lenght: .l_304_211_171, type: .s_1024, date: Date(year: 2018, month: 12, day: 31, hour: 0, minute: 0)):
        URL(string: "http://suntoday.lmsal.com/sdomedia/SunInTime/2018/12/31/l_304_211_171.jpg")!,
        
        .init(lenght: .l_304_211_171, type: .pfss, date: Date(year: 2020, month: 01, day: 03, hour: 0, minute: 0)):
        URL(string: "http://suntoday.lmsal.com/sdomedia/SunInTime/2020/01/03/f_304_211_171pfss.jpg")!,
        
        .init(lenght: .l_304_211_171, type: .pfssnolines, date: Date(year: 2020, month: 01, day: 03, hour: 0, minute: 0)):
